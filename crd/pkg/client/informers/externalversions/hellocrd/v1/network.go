...
import (
	...
	v1 "crd/pkg/client/listers/hellocrd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.HellocrdV1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HellocrdV1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&hellocrdv1.Network{},
		resyncPeriod,
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hellocrdv1.Network{}, f.defaultInformer)
}
