...
import (
	...
	samplecrdv1 "crd/pkg/apis/hellocrd/v1"

	clientset "crd/pkg/client/clientset/versioned"
	networkscheme "crd/pkg/client/clientset/versioned/scheme"
	informers "crd/pkg/client/informers/externalversions/hellocrd/v1"
	listers "crd/pkg/client/listers/hellocrd/v1"
)
